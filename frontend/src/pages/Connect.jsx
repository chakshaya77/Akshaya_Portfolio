...
const Connect = () => {
  return (
    <div style={{ minHeight: 'calc(100vh - 100px)', padding: '4rem 2rem', display: 'flex', justifyContent: 'center', alignItems: 'flex-start' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', maxWidth: '1200px', width: '100%' }}>
        ...
        <div className="glass-card" style={{ flex: '1 1 600px', padding: '2.5rem' }}>
        ...
        <div style={{ flex: '1 1 350px', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <div className="glass-card" style={{ padding: '2.5rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem', marginBottom: '2rem' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '0.95rem', color: '#fff', fontFamily: 'Inter, sans-serif' }}>akshaya.chittimilla@gmail.com</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '0.95rem', color: '#fff', marginBottom: '6px', fontFamily: 'Inter, sans-serif' }}>37.7749° N, 122.4194° W</div>
                <div style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.4)', fontFamily: 'Inter, sans-serif' }}>San Francisco, California</div>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card" style={{ padding: '2.5rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              ...
              <a href="https://github.com/chakshaya77" target="_blank" rel="noreferrer" style={{ background: '#0e0e0e', border: '1px solid rgba(255,255,255,0.04)', borderRadius: '12px', padding: '1.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', color: 'rgba(255,255,255,0.6)', textDecoration: 'none', transition: 'all 0.3s' }}>
              ...
              <a href="https://x.com/AkshayaCh_7" target="_blank" rel="noreferrer" style={{ background: '#0e0e0e', border: '1px solid rgba(255,255,255,0.04)', borderRadius: '12px', padding: '1.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', color: 'rgba(255,255,255,0.6)', textDecoration: 'none', transition: 'all 0.3s' }}>
              ...
              <div style={{ background: '#0e0e0e', border: '1px solid rgba(255,255,255,0.04)', borderRadius: '12px', padding: '1.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', color: 'rgba(255,255,255,0.6)', textDecoration: 'none', transition: 'all 0.3s', cursor: 'pointer' }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                <span style={{ fontSize: '0.65rem', textTransform: 'uppercase', letterSpacing: '0.1em', fontFamily: 'Inter, sans-serif', color: 'rgba(255,255,255,0.5)', fontWeight: 600 }}>CV DOC</span>
              </div>
